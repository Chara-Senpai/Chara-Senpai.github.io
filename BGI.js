...
var parallaxCoeff = 2;      // was 3 — calmer drift, easier to read text over
var globalScale = 1;
var brightness = 1.5;
var repulsion = .95;
var noise = .03;            // subtle grain instead of a flat, glossy render
...
// Gold-dusk grade: warm hue shift + slight desaturation + dimmed
// brightness so the scene reads as a HUD backdrop, not the main event.
colorMatrix.hue(18, false);
colorMatrix.saturate(-0.15, true);
colorMatrix.contrast(0.06, true);
colorMatrix.brightness(0.82, true);
